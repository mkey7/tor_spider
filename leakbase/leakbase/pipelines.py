...
from leakbase.dwItems.goods_item import GoodsItem
...
from leakbase.settings import MYSQL_HOST, MYSQL_DB_NAME, MYSQL_USER, MYSQL_PORT, MYSQL_PASSWD, \
    MYSQL_CHARSET

logger = logging.getLogger(__name__)


class LeakbasePipeline:
    def __init__(self, dbpool):
        self.dbpool = dbpool
        self.ITME_TYPE_MAP = {
            ('leakbase', PostItem): self.do_insert_forums_post,
            ('leakbase', GoodsItem): self.do_insert_forums_goods,
            ('leakbase', UserItem): self.do_insert_forums_user,
            ('leakbase', SiteItem): self.do_insert_site_info,
            ('leakbase', PageItem): self.do_insert_forums_original_page,
        }
        self.POST_FIELDS = [
        ...
        self.GOODS_FIELDS = [
            "uuid", "goods_id", "platform", "domain", "goods_name", "goods_info", "images", "attachments",
