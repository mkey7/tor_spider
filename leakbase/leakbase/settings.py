# Scrapy settings for leakbase project
#
...
SPIDER_MODULES = ["leakbase.spiders"]
NEWSPIDER_MODULE = "leakbase.spiders"
...
DOWNLOADER_MIDDLEWARES = {
    ...
    # "leakbase.dwMiddlewares._proxy.ProxyMiddleware": 450,
    "leakbase.dwMiddlewares.lb_login.LeakBaseLoginMiddleware": 556,
    'leakbase.dwMiddlewares._selenium_midd.SeleniumMiddleware': 800,
}
...
ITEM_PIPELINES = {
    ...
    "leakbase.dwPipelines.dwImages.DwImagesPipeline": 300,
    "leakbase.pipelines.LeakbasePipeline": 301,
}
...
AWS_ENDPOINT_URL = 'http://43.154.80.35:9000'
...
MINIO_ENDPOINT = '43.154.80.35:9000'
MINIO_SECURE = False

MYSQL_HOST = "43.154.80.35"
MYSQL_PORT = 3306
MYSQL_USER = "root"
...
# ---------------------------chrome配置-----------------------
SHOW_BROWSER = False
SELENIUM_DRIVER_ARGUMENTS = ['--no-sandbox', '--disable-dev-shm-usage', '--disable-gpu', '--disable-extensions',
                             '--disable-incognito', '--ignore-certificate-errors', '--disable-default-apps',
...
SELENIUM_DRIVER_EXP_ARGUMENTS = {'excludeSwitches': ['enable-automation'],
                                 ...
                                 "prefs": {"credentials_enable_service": False,  # 添加去掉密码弹窗管理
                                           ...
                                           "download.default_directory": "./images",
